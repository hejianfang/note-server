    ...
    Cn8e: function (t, e) {
        ...
        var _ = n("VU/8")(f, g, !1, function (t) {
            ...
            name: "test", data: function () {
                ...
                value: function () {
                    var t = {editorContent: this.editorContent, editorContents: this.editorContents};
                    this.$emit("content", t)
                }
            }, mounted: function () {
        ...
        var C = n("VU/8")(x, k, !1, function (t) {
            n("E1Iw")
        }, null, null).exports, y = n("mtWM"), b = n.n(y), z = {
        ...
        var F = n("VU/8")(z, E, !1, function (t) {
            n("S5RT")
        }, "data-v-edca758e", null).exports, $ = {
            name: "writes", components: {Header: d, test: C, pic: F}, data: function () {
                return {title: "", conent: "", classify: "", pic: ""}
            }, methods: {
                getdata: function (t) {
                    this.conent = t.editorContent, this.conents = t.editorContents
                }, getimg: function (t) {
                    this.pic = t
                }, getswiper: function () {
                    var t = {title: this.title, pic: this.pic, content: this.conent, contents: this.conents};
                    this.$axios.post("swipers", t).then(function (t) {
                        200 == t.data.code && alert("生成成功")
                    })
                }, handleClick: function () {
                    var t = this, e = {title: this.title, conent: this.conent, classify: this.classify};
                    this.$axios.post("addnote", e).then(function (e) {
                        200 == e.data.code && (alert("发布成功"), t.$router.push("/"))
                    })
                }
            }
        }, H = {
            render: function () {
                ...
                })]), t._v(" "), n("div", {staticClass: "pic"}, [n("pic", {on: {imge: t.getimg}}), t._v(" "), n("button", {on: {click: t.getswiper}}, [t._v("生成轮播图")])], 1), t._v(" "), n("div", [n("h2", [t._v("内容")]), t._v(" "), n("test", {on: {content: t.getdata}})], 1), t._v(" "), n("div", [n("span", [t._v("标签")]), n("span", [n("input", {
                    directives: [{
                        name: "model",
                        rawName: "v-model",
                        value: t.classify,
        ...
        var R = n("VU/8")($, H, !1, function (t) {
            n("TSfg")
        }, "data-v-131ed5cc", null).exports, N = n("PJh5"), P = n.n(N), q = {
            components: {Header: d}, data: function () {
                ...
                getdata: function () {
                    ...
                    this.$axios.get("notedetail", {_id: e}).then(function (e) {
                        t.name = e.data.data.name, t.newname = e.data.users.name, t.conent = e.data.data.conent, t.title = e.data.data.title, t.id = e.data.data._id, t.userid = e.data.data.id, t.update = P()(e.data.data.update).format("YYYY-MM-DD hh:mm:ss")
                    })
                }, submt: function () {
            ...
            render: function () {
                var t = this, e = t.$createElement, n = t._self._c || e;
                return n("div", [n("Header"), t._v(" "), n("div", {staticClass: "wrap"}, [n("div", {staticClass: "wrap-top"}, [n("h1", [t._v(t._s(t.title))]), t._v(" "), n("p", [n("span", [t._v("作者：" + t._s(t.name))]), t._v(" "), n("span", [t._v(t._s(t.update))])])]), t._v(" "), n("div", {staticClass: "title"}, [n("p", {domProps: {innerHTML: t._s(t.conent)}})]), t._v(" "), n("ul", t._l(t.arr, function (e) {
                    return n("li", [n("span", [t._v(t._s(e.name))]), t._v(" "), n("span", [t._v(":")]), t._v(" "), n("span", [t._v(t._s(e.conents))])])
        ...
        var L = n("VU/8")(q, T, !1, function (t) {
            n("H055")
        }, "data-v-7e29adab", null).exports, S = {
        ...
        var O = n("VU/8")(S, U, !1, function (t) {
            n("OPgw"), n("nzro")
        }, "data-v-3ffc24e8", null).exports, M = {
            name: "Sixiang", data: function () {
        ...
        var W = n("VU/8")(M, V, !1, function (t) {
            n("ts5b"), n("yZsW")
        }, "data-v-6f1c2a46", null).exports, I = {
            name: "userschange", components: {Header: d, pic: F}, data: function () {
        ...
        var B = new c.a({
            routes: [{path: "/", name: "index", component: m}, {
                ...
                name: "picup",
                component: W
            }, {path: "/userschange", name: "userschange", component: X}]
        }), Y = n("7QTg"), Z = n.n(Y), A = (n("v2ns"), n("//Fk")), G = n.n(A), J = {
            swiper: "/swipers",
            register: "/region",
            login: "/login",
            getmsg: "/getMsg",
            ...
            swipers: "/swipers"
        }, K = b.a.create({baseURL: "/", timeout: 5e3, withCredentials: !0}), Q = {
            get: function (t, e, n) {
                return new G.a(function (a, s) {
                    K.get(J[t], {params: e, config: n}).then(function (t) {
                        t.data.code, a(t)
                    })
                })
            }, post: function (t, e, n) {
                return new G.a(function (a, s) {
                    K.post(J[t], e, n).then(function (t) {
                        t.data.code, a(t)
                    })
                })
            }
        };
        a.default.prototype.$axios = Q, a.default.use(Z.a), a.default.use(i.a), a.default.config.productionTip = !1, new a.default({
            el: "#app",
            router: B,
            components: {App: r},
            template: "<App/>"
...
//# sourceMappingURL=app.cc8faf7285e53ecd755a.js.map